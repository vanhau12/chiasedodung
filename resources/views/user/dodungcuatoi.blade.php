                            ...
                            @foreach ($data['postitems'] as $item)
                              <tr class="text-center">
                                <td class="product-remove">
                                    <a href="{{route('xoadodung',$item->id)}}"><span class="ion-ios-close"></span></a>
                                    <a href="{{route('getsuadodung',$item->id)}}"><span class="ion-md-brush"></span></a>
                                </td>
            ...
            <div class="col-md-12 ftco-animate">
                <div class="cart-list">
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($data['passitems'] as $item)
                              <tr class="text-center">
                                <td class="product-remove"><a href="{{route('xoadodung',$item->id)}}"><span class="ion-ios-close"></span></a><a href="{{route('getsuadodung',$item->id)}}"><span class="ion-ios-brush"></span></a></td>
                    ...
                    <div class="col-md-12">
                        <div class="">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    {{ $data['passitems']->links("pagination::bootstrap-4") }}
                                </ul>
                            </nav>
                        </div>
                    </div>
