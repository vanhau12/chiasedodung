...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 23, 2019 lúc 04:44 PM
...
(1, 39, 3, 4, 'toi muon dung vi chung dep', 2, 1574499115, 1574503116),
(2, 3, 3, 4, 'toi muon trao doi', 1, 1574500067, 1574500871),
(3, 8, 1, 4, 'haha', 2, 1574500892, 0);
...
(51, 2, 1, 'Thanh lý chén đĩa số lượng nhiều', 'Liên hệ', '', '1517806423_full.jpg&width=350.jpg', 'TP.Hồ Chí Minh', '', 8, 0, 0, 1573402580),
...
(54, 2, 4, 'Thanh lý bàn ghế theo phong cách cổ', 'Liên hệ', '', '1458032548_full.jpg&width=350.jpg', 'Hà Nội', '<p>B&agrave;n ghế cổ</p>', 10, 0, 0, 1573402580),
(56, 1, 1, 'Nguyễn Văn B', 'asdasd', '', 'suahd.PNG', 'adsfadf', '', 1, 0, 1, 1573440344),
(58, 1, 4, 'aasd', 'trao doi do vat day thi sao', '', 'dangnhap.png', 'lao cai', '<p>aaaaaaaaaa</p>', 0, 0, 1, 1574432303);
...
(1, 'Nguyễn Văn Ba', 'fcea920f7412b5da7be0cf42b8c93759', '123456@gmail.com', '0399583826', 0, 0, 0),
(2, '', 'd41d8cd98f00b204e980', '', '', 1, 0, 0),
(3, 'HauVan', 'e10adc3949ba59abbe56e057f20f883e', '12312@gmail.com', '399583826', 0, 0, 1574328088),
(4, 'nguoi dung', 'e10adc3949ba59abbe56e057f20f883e', '123@gmail.com', '0399583826', 1, 0, 1574328223),
(5, '', '', '', '', 0, 0, 1574329321);
...
--
ALTER TABLE `contact`
  ADD CONSTRAINT `11` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `12` FOREIGN KEY (`petitioner`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `13` FOREIGN KEY (`acceptor`) REFERENCES `user` (`id`);

--
-- Các ràng buộc cho bảng `item`
--
ALTER TABLE `item`
  ADD CONSTRAINT `5` FOREIGN KEY (`type_id`) REFERENCES `type_item` (`id`),
  ADD CONSTRAINT `6` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
