...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 24, 2019 lúc 06:20 PM
...
INSERT INTO `cart` (`id`, `user_id`, `item_id`, `createdate`) VALUES
(1, 1, 1, 1574614433),
(2, 1, 3, 1574614758),
(3, 1, 9, 1574614763),
(4, 1, 22, 1574614787),
...
INSERT INTO `contact` (`id`, `item_id`, `petitioner`, `acceptor`, `message`, `status`, `sent_date`, `accept_date`) VALUES
(1, 3, 1, 3, 'Tôi đang cần sử dụng chiếc tủ lạnh này. Tôi có thể mua lại hoặc thuê nó không?', 0, 1574614710, 0),
(2, 1, 2, 1, 'Tôi muốn sử dụng chiéc máy lạnh của bạn. Tôi có thể thuê hoặc mua lại không?', 0, 1574615013, 0),
(3, 7, 2, 2, 'Chiếc máy lạnh này là thứ tôi đang tìm. Tôi có thế trao đổi với bạn bằng một cái tủ lạnh ngang giá không?', 0, 1574615236, 0),
(4, 41, 2, 1, 'Tôi muốn mua bộ bàn ghế này !', 1, 1574615337, 1574615443),
(5, 26, 2, 1, 'Tôi muốn trao đổi máy này với một chiếc điện thoại iphone 11 pro', 2, 1574615602, 1574615716);
...
(24, 1, 4, 'MÁY LẠNH MITSUBISHI 1HP 977', '2,400,000đ', '', 'thumb_1561804316_may-lanh-mitsubishi-1hp-977.jpg', 'Hà Nội', '<br>', 0, 0, 0, 1573402580),
(25, 1, 5, 'Tủ mát ướp rượu 962', '1,500,000đ', '', 'thumb_1569404371_tu-mat-uop-ruou-962.jpg', 'Hà Nội', '<br>', 0, 0, 0, 1573402580),
...
(41, 2, 1, 'Salon bàn ghế gỗ đỏ 1055', '17,000,000đ', 'Thiết kế đẹp, rộng rãi, làm mát tốt. Có thể cho mượn hoặc cho thuê', '1569815399_full.jpg&width=350.jpg', 'Hà Nội', '    T&igrave;nh trang: mới 95%&nbsp;<br>    Chất liệu: Gỗ đỏ tay 8&nbsp;<br>    Bao gồm: 6 m&oacute;n 2 ghế đ&ocirc;n,&nbsp;1 ghế d&agrave;i, 2 ghế đơn v&agrave; 1 b&agrave;n&nbsp;<br>    Vơi đặc trưng l&agrave; thớ gỗ d&agrave;y v&agrave; mịn, với đặc t&iacute;nh chống mối , mọt tự nhi&ecirc;n được xử l&yacute; để chống cong v&ecirc;nh, m&agrave;u sắc v&agrave; v&acirc;n gỗ đẹp G&otilde; đỏ l&agrave; loại gỗ được đ&aacute;nh gi&aacute; cao trong việc chế tạo v&agrave; sử dụng l&agrave;m đồ nội thất, mỹ nghệ, &hellip;<br>   <span style=\"color:#c0392b;\"><strong>Bộ b&agrave;n ghế gỗ g&otilde; đỏ tay 8</strong></span>&nbsp;m&agrave; <b>Đồ cũ tuấn hưng</b>&nbsp;thanh l&yacute; lại&nbsp;bảo đảm đ&uacute;ng <strong>gỗ đỏ 100%</strong>, gỗ được lựa chọn v&agrave; xử l&yacute; kỹ trước khi sản xuất nhằm đảm bảo sản phẩm c&oacute; độ bền cao v&agrave; đạt chất lượng tốt nhất độ bền tr&ecirc;n 30 năm.&nbsp;<br>    Ngo&agrave;i ra, ch&uacute;ng t&ocirc;i c&ograve;n c&oacute; rất nhiều c&aacute;c loại<em><strong> b&agrave;n ghế gỗ </strong></em>đa dạng với k&iacute;ch thước v&agrave; gi&aacute; cả kh&aacute;c nhau cho qu&yacute; kh&aacute;ch lựa chọn, h&atilde;y c&ugrave;ng đến <em><strong>đồ cũ tuấn hưng</strong></em> để chi&ecirc;m ngưỡng kh&ocirc;ng chỉ b&agrave;n ghế m&agrave; c&oacute; cả c&aacute;c tủ, sập, b&igrave;nh phong, tượng đồ<a href=\"https://thanhlyhangcu.vn/thanh-ly-do-go-cu-co-xua/\" target=\"_blank\"> <span style=\"color:#f39c12;\"><strong>gỗ cũ gỗ xưa cao cấp thanh l&yacute; gi&aacute; rẻ</strong></span></a>.<br>', 4, 0, 2, 1573402580),
(42, 2, 2, 'Bộ bàn ghế gia đình xưa 1041', '20,000,000đ', 'Thiết kế đẹp, rộng rãi, làm mát tốt. Có thể cho mượn hoặc cho thuê', '1565427167_full.jpg&width=350.jpg', 'Hà Nội', '    Chất liệu: B&agrave;n gỗ đỏ&nbsp;<br>   Ghế cẩm lai&nbsp;&nbsp;<br>   T&igrave;nh trạng: mới 90%&nbsp;<br>    Phong c&aacute;ch cổ xưa qu&yacute; hiếm&nbsp;&nbsp;<br>', 0, 0, 0, 1573402580),
(43, 2, 3, 'Tủ mát ướp rượu 962', '10,000,000đ', 'Thiết kế đẹp, rộng rãi, làm mát tốt. Có thể cho mượn hoặc cho thuê', '1562057472_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580),
(44, 2, 4, 'CHẬU RỬA CHÉN  ', '850,000đ', 'Thiết kế đẹp, rộng rãi, làm mát tốt. Có thể cho mượn hoặc cho thuê', '1552371149_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580),
(45, 2, 5, 'THANH LÝ TỦ THẦN TÀI  ', '1,500,000đ', 'Thiết kế đẹp, rộng rãi, làm mát tốt. Có thể cho mượn hoặc cho thuê', '1552370964_full.jpg&width=350.jpg', 'Hà Nội', '   B&agrave;i vị thần t&agrave;i chạm 25x35<br>', 0, 0, 0, 1573402580),
(46, 2, 1, 'Salon gỗ gia đình thanh lý', 'Liên hệ', 'Thiết kế đẹp, rộng rãi, làm mát tốt. Có thể cho mượn hoặc cho thuê', '1542268064_full.jpg&width=350.jpg', 'TP.Hồ Chí Minh', '', 0, 0, 1, 1573402580),
(47, 2, 2, 'Bán bộ Sơn Thủy gỗ Trắc', 'Liên hệ', 'Thiết kế đẹp, rộng rãi, làm mát tốt. Có thể cho mượn hoặc cho thuê', '1527503366_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580),
(48, 2, 3, 'thanh lý giường gỗ đẹp giá rẻ', 'Liên hệ', '', '1525924534_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580),
(49, 2, 4, 'Giường gỗ đẹp thanh lý ', 'Liên hệ', '', '1525924365_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580),
(50, 2, 5, 'salon gổ cẩm lai thanh lý ', '18,000,000đ', '', '1521279243_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580),
(51, 2, 1, 'Thanh lý chén đĩa số lượng nhiều', 'Liên hệ', '', '1517806423_full.jpg&width=350.jpg', 'TP.Hồ Chí Minh', '', 1, 0, 1, 1573402580);
INSERT INTO `item` (`id`, `type_id`, `user_id`, `name`, `request`, `introduce`, `image`, `place`, `description`, `view`, `liked`, `status`, `createdate`) VALUES
(52, 2, 2, 'thanh lý salon nhựa giả mây giá rẻ', 'Liên hệ', '', '1506760513_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580),
(53, 2, 3, 'giường gỗ giá rẻ thanh lý', 'Liên hệ', '', '1494063667_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580),
(54, 2, 4, 'Thanh lý bàn ghế theo phong cách cổ', 'Liên hệ', '', '1458032548_full.jpg&width=350.jpg', 'Hà Nội', '', 0, 0, 0, 1573402580);
...
INSERT INTO `type_item` (`id`, `name`, `status`) VALUES
(1, 'Đồ điện gia dụng', 0),
(2, 'Đồ nội thất', 0),
(3, 'Đồ văn phòng', 0),
(4, 'Đồ dùng học tập', 0),
(5, 'Thiết bị điện tử', 0);
